...
class SheduleTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("TableViewController did Load")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let shedule = shedules[indexPath.row]
        cell.endTimeLabel.text = shedule.endTime
        cell.startTimeLabel.text = shedule.startTime
        cell.teacherLabel.text = shedule.teacher
        cell.sportNameLabel.text = shedule.name
        cell.roomLabel.text = shedule.place
